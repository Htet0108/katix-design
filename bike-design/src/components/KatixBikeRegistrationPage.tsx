...
import { BikeCustomerForm } from "@/components/katix/bike-customer-form";
import { DamagePhotosSection } from "@/components/katix/damage-photos-section";
import { DocumentsSection } from "@/components/katix/documents-section";
import { isRequiredUploadSlot, type RequiredUploadSlotId } from "@/components/katix/photo-slot-guides";
import { shouldShowUploadGuide } from "@/components/katix/photo-upload-guide-prefs";
import { PhotoUploadGuideModal } from "@/components/katix/photo-upload-guide-modal";
import {
  BIKE_ILLUSTRATION_PREVIEW_BOX,
  BikeIllustrationSlot,
  FREE_PLUS_PLACEHOLDER,
  PhotoUploadCard,
} from "@/components/katix/photo-upload-card";
import { useKatixForm, type KatixFormState } from "@/components/katix/use-katix-form";
import {
  scrollToFirstError,
  validateKatixForm,
  type KatixFormErrors,
} from "@/components/katix/validate-katix-form";
import {
  IconPhone,
  IconQuestion,
} from "@/components/katix/icons";
import { KatixFooter, KatixHeader, KatixPageBody, KatixPageShell } from "@/components/katix/katix-page-shell";
import { KatixSectionBanner } from "@/components/katix/katix-section-banner";
import {
  KATIX_CONTENT_WIDTH,
  KATIX_MAIN,
  KATIX_MAIN_INNER,
