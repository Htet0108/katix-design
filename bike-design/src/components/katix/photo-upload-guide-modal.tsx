...
import { IconCamera, IconCaretRight, IconQuestion } from "@/components/katix/icons";
import {
  OkNgSampleComparison,
  PhotoGuideModalShell,
  UploadModalBulletTips,
} from "@/components/katix/photo-guide-shared";
import { dismissUploadGuideForSlot } from "@/components/katix/photo-upload-guide-prefs";
import {
  getPhotoSlotGuide,
  getSlotProgressLabel,
  type RequiredUploadSlotId,
} from "@/components/katix/photo-slot-guides";
